 ...
 * 获取工作流的所有连接
 */
router.get('/:workflowId/connections', ...nodeController_1.getWorkflowConnectionsController);
// ============ 保存整个工作流 ============
/**
 * PUT /api/workflows/:workflowId/save
 * 保存整个工作流（包含节点和连接）
 */
router.put('/:workflowId/save', ...nodeController_1.updateWorkflowController);
// ============ 单个节点路由 ============
/**
 * PUT /api/nodes/:id
 * 更新节点
