...
exports.updateNodeController = [
    ...
    async (req, res) => {
        try {
            ...
            const result = await (0, nodeService_1.updateNodeService)(nodeId, userId, {
                label,
                positionX,
                positionY,
                data,
...
exports.deleteNodeController = [
    ...
    async (req, res) => {
        try {
            const nodeId = req.params.id;
            const userId = req.user.userId;
            await (0, nodeService_1.deleteNodeService)(nodeId, userId);
...
exports.deleteConnectionController = [
    ...
    async (req, res) => {
        try {
            ...
            const userId = req.user.userId;
            await (0, nodeService_1.deleteConnectionService)(connectionId, userId);
