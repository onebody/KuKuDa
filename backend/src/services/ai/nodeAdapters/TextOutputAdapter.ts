 ...
 */
export class TextOutputAdapter extends BaseNodeAdapter {
   ...
   * @returns 是否有效
   */
  private isValidOutputData(data: any): boolean {
  ...
  private async saveToFile(
    ...
    console.log(
      `[TextOutputAdapter] 保存文件: ${fileUrl}, 编码: ${encoding}, 大小: ${text.length} 字节`
    )
